...
public class CaseAvailableRuntime : CaseRuntimeBase, ICaseAvailableRuntime
{
    ...
    public CaseAvailableRuntime(PayrollHttpClient httpClient, ScriptContext scriptContext, int tenantId,
        int userId, int payrollId, Case @case, int? employeeId = null) :
        base(httpClient, scriptContext, tenantId, userId, payrollId, @case, employeeId)
    {
    }
